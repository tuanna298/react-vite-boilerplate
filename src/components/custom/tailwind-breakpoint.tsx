const TailwindBreakpoint = () => {
  return (
    <div className="fixed bottom-0 right-0 z-50 m-2 flex items-center rounded border border-gray-400 bg-gray-300 p-2 text-sm text-pink-600">
      <svg
      ...
      <span className="xs:inline ml-1 hidden font-extrabold sm:hidden">xs</span>
      ...
      <span className="ml-1 hidden font-extrabold xl:inline 2xl:hidden">
        xl
      </span>
      <span className="3xl:hidden ml-1 hidden font-extrabold 2xl:inline">
        2xl
      </span>
      <span className="3xl:inline ml-1 hidden font-extrabold">2xl</span>
    </div>
  )
}
